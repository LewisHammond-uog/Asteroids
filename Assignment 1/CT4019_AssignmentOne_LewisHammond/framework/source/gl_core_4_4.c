...
void (CODEGEN_FUNCPTR *_ptrc_glBeginConditionalDraw)(GLuint, GLenum) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glBindDrawbuffer)(GLenum, GLuint) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glDeleteDrawbuffers)(GLsizei, const GLuint *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glEndConditionalDraw)() = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glFramebufferDrawbuffer)(GLenum, GLenum, GLenum, GLuint) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glGenDrawbuffers)(GLsizei, GLuint *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glGetDrawbufferParameteriv)(GLenum, GLenum, GLint *) = NULL;
...
GLboolean (CODEGEN_FUNCPTR *_ptrc_glIsDrawbuffer)(GLuint) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glDrawbufferStorage)(GLenum, GLenum, GLsizei, GLsizei) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glDrawbufferStorageMultisample)(GLenum, GLsizei, GLenum, GLsizei, GLsizei) = NULL;
...
static int Load_Version_4_4()
{
	...
	_ptrc_glBeginConditionalDraw = (void (CODEGEN_FUNCPTR *)(GLuint, GLenum))IntGetProcAddress("glBeginConditionalDraw");
	if(!_ptrc_glBeginConditionalDraw) numFailed++;
	...
	_ptrc_glBindDrawbuffer = (void (CODEGEN_FUNCPTR *)(GLenum, GLuint))IntGetProcAddress("glBindDrawbuffer");
	if(!_ptrc_glBindDrawbuffer) numFailed++;
	...
	_ptrc_glDeleteDrawbuffers = (void (CODEGEN_FUNCPTR *)(GLsizei, const GLuint *))IntGetProcAddress("glDeleteDrawbuffers");
	if(!_ptrc_glDeleteDrawbuffers) numFailed++;
	...
	_ptrc_glEndConditionalDraw = (void (CODEGEN_FUNCPTR *)())IntGetProcAddress("glEndConditionalDraw");
	if(!_ptrc_glEndConditionalDraw) numFailed++;
	...
	_ptrc_glFramebufferDrawbuffer = (void (CODEGEN_FUNCPTR *)(GLenum, GLenum, GLenum, GLuint))IntGetProcAddress("glFramebufferDrawbuffer");
	if(!_ptrc_glFramebufferDrawbuffer) numFailed++;
	...
	_ptrc_glGenDrawbuffers = (void (CODEGEN_FUNCPTR *)(GLsizei, GLuint *))IntGetProcAddress("glGenDrawbuffers");
	if(!_ptrc_glGenDrawbuffers) numFailed++;
	...
	_ptrc_glGetDrawbufferParameteriv = (void (CODEGEN_FUNCPTR *)(GLenum, GLenum, GLint *))IntGetProcAddress("glGetDrawbufferParameteriv");
	if(!_ptrc_glGetDrawbufferParameteriv) numFailed++;
	...
	_ptrc_glIsDrawbuffer = (GLboolean (CODEGEN_FUNCPTR *)(GLuint))IntGetProcAddress("glIsDrawbuffer");
	if(!_ptrc_glIsDrawbuffer) numFailed++;
	...
	_ptrc_glDrawbufferStorage = (void (CODEGEN_FUNCPTR *)(GLenum, GLenum, GLsizei, GLsizei))IntGetProcAddress("glDrawbufferStorage");
	if(!_ptrc_glDrawbufferStorage) numFailed++;
	_ptrc_glDrawbufferStorageMultisample = (void (CODEGEN_FUNCPTR *)(GLenum, GLsizei, GLenum, GLsizei, GLsizei))IntGetProcAddress("glDrawbufferStorageMultisample");
	if(!_ptrc_glDrawbufferStorageMultisample) numFailed++;
