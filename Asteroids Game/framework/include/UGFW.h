...
#pragma region Sprite creation and mainpulation functionality
	...
	/// This function is used to set the layer that the sprite will be Drawed on, lower layers are Drawed first
	...
	/// This function is used to Get the layer that the sprite is currently Drawed on, lower layers are Drawed first
	/// @param a_iSpriteID the Unique ID that is used for the sprite
...
#pragma endregion
#pragma region Font Drawing functionality
	...
	///			the deeper parts of the font Drawering functionality
	/// @param a_v4Color the color that the text is to be Drawed in
